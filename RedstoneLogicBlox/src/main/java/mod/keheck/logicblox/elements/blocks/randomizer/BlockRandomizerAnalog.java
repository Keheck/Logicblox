...
public class BlockRandomizerAnalog extends GateBase implements ITileEntityProvider, OneIn
{
    ...
    public BlockRandomizerAnalog(String name) { super(name); }
    ...
    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.ITEM_RANDOMIZER_ANALOG; }
