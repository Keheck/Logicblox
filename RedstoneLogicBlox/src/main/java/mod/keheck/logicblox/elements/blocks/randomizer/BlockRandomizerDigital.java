package mod.keheck.logicblox.elements.blocks.randomizer;
...
public class BlockRandomizerDigital extends GateBase implements ITileEntityProvider, OneIn
{
    public BlockRandomizerDigital(String name) { super(name); }
    ...
    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.ITEM_RANDOMIZER_DIGITAL; }
