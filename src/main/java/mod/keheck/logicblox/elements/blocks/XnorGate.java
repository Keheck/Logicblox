...
public class XnorGate extends GateBase implements TwoIn
{

    public XnorGate(String name) { super(name); }

    @Override
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        EnumFacing facing = unpoweredState.getValue(FACING);
        return BlockInit.XNOR_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, true);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.XNOR_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, false);
    }
    ...
    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.XNOR_GATE_BLOCK_ITEM; }
}
