...
public class AndGate extends GateBase implements TwoIn
{
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.AND_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, true);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.AND_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, false);
    }
    ...
    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.AND_GATE_BLOCK_ITEM; }
}
