...
public class OrGate extends GateBase implements TwoIn
{
    public OrGate(String name) { super(name); }

    @Override
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        EnumFacing facing = unpoweredState.getValue(FACING);
        return BlockInit.OR_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, true);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.OR_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, false);
    }
    ...
    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.OR_GATE_BLOCK_ITEM; }
