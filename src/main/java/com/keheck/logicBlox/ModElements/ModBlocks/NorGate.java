...
public class NorGate extends GateBase implements TwoIn
{

    public NorGate(String name) { super(name); }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.NOR_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, true);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.NOR_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, false);
    }

    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.NOR_GATE_BLOCK_ITEM; }
}
