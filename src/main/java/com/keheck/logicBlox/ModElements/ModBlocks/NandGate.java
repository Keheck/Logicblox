...
public class NandGate extends GateBase implements TwoIn
{
    public NandGate(String name) { super(name); }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.NAND_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, true);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.NAND_GATE.getDefaultState().withProperty(FACING, facing).withProperty(ACTIVE, false);
    }

    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ItemInit.NAND_GATE_BLOCK_ITEM; }
}
