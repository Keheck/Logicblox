...
public class NorGate extends GateBase
{

    public NorGate(String name, boolean isOpened)
    {
        super(name, isOpened);
    }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.NOR_GATE_OPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.NOR_GATE_UNOPENED.getDefaultState().withProperty(FACING, facing);
    }

    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return ItemInit.nor_gate_block_item;
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ItemInit.nor_gate_block_item);
    }
}
