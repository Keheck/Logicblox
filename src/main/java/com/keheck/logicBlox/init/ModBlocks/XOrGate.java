...
public class XOrGate extends GateBase
{
    public XOrGate(String name, boolean isOpened)
    {
        super(name, isOpened);
    }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.XOR_GATE_OPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.XOR_GATE_UNOPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    {
        return ItemInit.xor_gate_block_item;
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ItemInit.xor_gate_block_item);
    }
