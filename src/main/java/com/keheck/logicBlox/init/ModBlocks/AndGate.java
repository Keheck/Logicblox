...
{
    public AndGate(String name, boolean isOpened)
    {
        super(name, isOpened);
    }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.AND_GATE_OPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.AND_GATE_UNOPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    {
        return ItemInit.and_gate_block_item;
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ItemInit.and_gate_block_item);
    }
}
