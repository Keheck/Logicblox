...
public class OrGate extends GateBase
{
    public OrGate(String name, boolean isOpened)
    {
        super(name, isOpened);
    }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.OR_GATE_OPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.OR_GATE_UNOPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    {
        return ItemInit.or_gate_block_item;
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ItemInit.or_gate_block_item);
    }
