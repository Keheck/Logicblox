...
public class XnorGate extends GateBase
{

    public XnorGate(String name, boolean isOpened)
    {
        super(name, isOpened);
    }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.XNOR_GATE_OPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.XNOR_GATE_UNOPENED.getDefaultState().withProperty(FACING, facing);
    }
    ...
    protected boolean shouldBePowered(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        return strength1 == 0 && strength2 == 0 || strength1 > 0 && strength2 > 0;
    }
    ...
    {
        return ItemInit.xnor_gate_block_item;
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ItemInit.xnor_gate_block_item);
    }
}
